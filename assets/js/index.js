...
//home page sections (top, rate, upcoming, trending movies)
...
//then change henre format eg: {123: "Action"}
...
const heroBanner = function({ results: movieList }) {
    ...
    for (const [index, movie] of movieList.entries()) {
        ...
        sliderItem.innerHTML = `
           <img src="${imageBaseURL}w1280${backdrop_path}" class="img-cover" alt="${title}" loading=${index === 0 ? "eagar" : "lazy"}>
            ...
            <div class="banner-content">
                ...
                <a href="./detail.html" class="btn" onclick="getMovieDetail(${id})">
                   <img src="./assets/images/play_circle.png" width="24" height="24" aria-hidden="true" alt="play cirle">
    ...
    //fecth data from home page sections (top, rated, upcoming, trending)
...
const addHeroSlide = function () {
    ...
    const sliderStart = function() {
        ...
        // `this` == slider-control
        const nextIndex = Number(this.getAttribute("slider-control"));
        sliderItems[nextIndex].classList.add("active");
        this.classList.add("active");

        lastSliderItem = sliderItems[nextIndex];
...
const createMovieList = function({ results: movieList }, title) {
    ...
    moveListElem.classList.add("movie-list");
    moveListElem.ariaLabel = `${title}`;
    ...
    for (const movie of movieList) {
        ...
        moveListElem.querySelector(".slider-inner").appendChild
        (movieCard);
    }
